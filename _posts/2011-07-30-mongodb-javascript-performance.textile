...
<blockquote>
<table border="1">
<tr><td>mongo + v8  </td><td>  93毫秒 </tr> 
<tr><td>mongo 1.8.2 (SpiderMonkey)  </td><td>  6623毫秒 </tr> 
 ...
 * SpiderMonkey 1.9.2 比v8慢5倍
 * mongodb使用SpiderMonkey(版本号?)肯定存在问题, 导致mongodb+SpiderMonkey比mongodb+v8慢60多倍;
