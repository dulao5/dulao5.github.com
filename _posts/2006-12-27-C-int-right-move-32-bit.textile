...
<div id="code0" class="altbg2" style="border: 1px solid #698cc3; margin: 3px 2em 2em; padding: 5px 10px 10px; clear: both; font-family: fixedsys;">&nbs unsigned int nn = ~0;
&nbs unsigned int ii = 0;
&nbs while( nn>>ii )
&nbs {
&nbs&nbsp; &nbsp;&nbsp;&nbsp;printf("%8x \n", nn>>ii);
&nbs&nbsp; &nbsp;&nbsp;&nbsp;ii++;
...
&nbs<span style="font-size: small;"><span style="font-weight: bold;">(nn>>32 == nn)</span>

</span>*粗浅的*查<Programming in C> , 书里面没有把>>的操作数超过32当作"未定义行为" .

从vc6里面看汇编，发现对应的指令是：
0040B89F&nbsmov&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;edx,dword ptr [ebp-4]
0040B8A2&nbsmov&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;ecx,dword ptr [ebp-8]
0040B8A5&nbsshr&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;edx,cl
