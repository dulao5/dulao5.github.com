...
####コミュニケーション五回目の結果
 * AJC_Call_Agent_007さんは詳細情報が知りません。
 * AJC_Call_Agent_007さんは担当者に確認します。

結果は？わかりません。多分AJC_Call_Agent_007さんは今まで確認しています？
その件はとても複雑なんですか？AJC_Call_Agent_007さんは私に連絡しません。

###コミュニケーション六回目：電話で
3月26日私はもう一回電話をしました。このパス。あの側は親切な女性です。然し彼女は状況が何も分からなっかた、何も知らなかった。
彼女は私と約束しました:「次の日Acerの情報を持ている人は私に電話で説明します」。

次の日は3月27日ですね。但し、今日までそ言うことがありません。
